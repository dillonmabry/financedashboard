 ...
 * Generated at: 2017-06-28 00:08:48 UTC
...
public final class preferences_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<li id=\"dashboardMenu\">\r\n");
      out.write("\t\t\t\t\t\t<a href=\"dashboard.jsp\">\r\n");
      out.write("\t\t\t\t\t\t<span class=\"glyphicon glyphicon-home\"></span>&nbsp;&nbsp; Dashboard\r\n");
      out.write("\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t<li class=\"active\" id=\"settingsMenu\"><a href=\"preferences.jsp\">Settings</a></li>\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      ...
      out.write("\t\t\t\t\t<center>\r\n");
      out.write("\t\t\t\t\t\t<h3>User Preferences</h3>\r\n");
      out.write("\t\t\t\t\t</center>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"userName\" type=\"userName\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"emailPref\">Email: </label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"emailPref\" type=\"emailPref\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"photoUrl\">Photo URL: </label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"photoUrl\" type=\"photoUrl\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"userId\">User ID: </label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input class=\"form-control\" id=\"userId\" type=\"userId\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\t\t\t\t\t\t\t   <span class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t        <button id=\"sendVerify\" class=\"btn btn-default btn-sm\">Re-send Verification Email</button>\r\n");
      out.write("\t\t\t\t\t\t\t   </span>\r\n");
      out.write("\t\t\t\t\t\t\t   <h4 id=\"userVerified\" class=\"text-right\"></h4>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t<script src=\"js/Screens/preferences/preferences.js\"></script>\r\n");
